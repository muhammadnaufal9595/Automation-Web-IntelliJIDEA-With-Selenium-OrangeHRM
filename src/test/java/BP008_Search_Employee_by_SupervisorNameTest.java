...
public class BP008_Search_Employee_by_SupervisorNameTest {
    ...
    public void main() throws InterruptedException {
        ...
        driver.findElement(By.id("empsearch_supervisor_name")).sendKeys("Muhammad Fakhri");
        //click search button
        driver.findElement(By.id("searchBtn")).click();
        //verify user is available
        String supervisor = driver.findElement(By.xpath("/html/body/div[1]/div[3]/div[2]/div/form/div[4]/table/tbody/tr/td[8]")).getText();
        Assert.assertEquals("Muhammad Fakhri", supervisor);
    }
}