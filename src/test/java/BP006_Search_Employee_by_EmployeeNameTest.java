...
public class BP006_Search_Employee_by_EmployeeNameTest {
    ...
    public void main() throws InterruptedException {
        ...
        driver.findElement(By.id("empsearch_employee_name_empName")).sendKeys("Daario Nahaerys");
        //click search button
        driver.findElement(By.id("searchBtn")).click();
        //verify user is available
        String daario = driver.findElement(By.xpath("//*[@id=\"resultTable\"]/tbody/tr/td[3]/a")).getText();
        Assert.assertEquals("Daario", daario);
        String nahaerys = driver.findElement(By.xpath("//*[@id=\"resultTable\"]/tbody/tr/td[4]/a")).getText();
        Assert.assertEquals("Nahaerys", nahaerys);
    }
}